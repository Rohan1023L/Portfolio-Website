...
//         <span data-value="1" id="read-text" class="${active === "1" ? "active" : ""}">Personal Information</span>
//         <span data-value="2" id="read-text" class="${active === "2" ? "active" : ""}">Internship Details</span>
//         <span data-value="back" id="read-text">Back</span>
//     `;
// }
